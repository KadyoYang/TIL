...
씨부아ㅓ라ㅐㅇㅁ너리ㅏㅁㄴ얼;ㅣㅇㅁ나러;ㅣㅁ안러; ㅣ아니 씨발 strcpy 를 쓰면 된다고 말을 하지 이 씨부럴 새끼들 책 만든새끼들 다 쳐패야해 씨부럴 아니 쑤부럴 지식인들도 똑같은놈들이야미친 능구렁이 같은 새끼들 존나 미끌미끌 빠져나가네 씨발
답은 제대로 안하고 헛소리만 씨부럴 놈들 좆같은 놈들
*/
/*
#include <iostream>
#define headnum 3
