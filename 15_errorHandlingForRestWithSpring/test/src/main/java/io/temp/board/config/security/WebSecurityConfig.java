...
import io.temp.board.config.security.filter.CustomAuthenticationFilter;
import io.temp.board.config.security.filter.JWTAuthorizationFilter;
import io.temp.board.config.security.handler.CustomLoginSuccessHandler;
import io.temp.board.config.security.provider.CustomAuthenticationProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public CustomAuthenticationFilter customAuthenticationFilter() throws Exception {
        ...
        customAuthenticationFilter.setFilterProcessesUrl("/api/user/login/deprecated");
