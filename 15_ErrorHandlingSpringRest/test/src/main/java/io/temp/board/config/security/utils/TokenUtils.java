package io.temp.board.config.security.utils;
...
public class TokenUtils {
    ...
    public static String generateJwtToken(TestAccount account){
    ...
    private static Map<String, Object> createClaims(TestAccount account){
