package com.template.config.email;
...
@Configuration
@PropertySource("classpath:/META-INF/email.properties")
@PropertySource("classpath:/META-INF/emailTemplate.properties")
public class EmailConfig {
	...
	@Value("${email.text.request.received}")private String requestReceivedText;
	@Value("${email.subject.request.received}")private String requestReceivedSubject;
	@Value("${email.text.request.processed}")private String requestProcessedText;
	@Value("${email.subject.request.processed}")private String requestProcessedSubject;
